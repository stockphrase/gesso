...
const tiles = [
  ...
  {
    title: "ASSIGNMENTS",
    description: "Submit and track your work",
    href: "/dashboard/assignments",
  },
  {
    title: "FILES",
    description: "Course readings and materials",
    href: "/dashboard/files",
  },
  {
    title: "CONTACT",
    description: "Instructor contact and office hours",
...
const studentTiles = [
  {
    title: "ANNOUNCEMENTS",
    description: "Updates from your instructor",
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-px bg-black m-8">
        {visibleTiles.map((tile) => (
          ...
          >
            <h3
              className={`text-base font-black tracking-tight uppercase group-hover:text-white ${
            ...
            <p
              className={`text-xs group-hover:text-gray-300 ${
